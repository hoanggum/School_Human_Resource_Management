...
?>
    ...
    <div class="container mt-5">
        ...
        <div class="form-container">
            <h2 class="mb-4">Thêm Khen Thưởng Mới</h2>
            <hr>
            <form method="POST" action="?page=processReward" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="Reason" class="form-label">Nội dung khen thưởng</label>
