...
<div class="container mt-5">
    <h1 class="mt-5 mb-4" style="text-align: center; color: rgb(0, 9, 35); font-size: 28px; font-weight: bold;">Danh sách Khen Thưởng</h1>
    <button type="button" class="btn btn-dark" style="width: 6%;height: 12%;" onclick="window.location.href = '?page=createReward';">
    ...
    <table class="table table-bordered" id="tblReward" >
